...
const Footer = (props: Props) => {
  return (
    <footer className="bg-base-300 mt-4 shadow ">
      <div className="mx-auto max-w-screen-xl space-y-8 px-4 py-16 sm:px-6 lg:space-y-16 lg:px-8">
        <div className="sm:flex sm:items-center sm:justify-between">
          <div className="text-teal-600">
            <h3 className="font-bold h-8">MAUZO</h3>
          </div>
        ...
        <div className="bg-base-200 h-[2rem] ">
          <p className="text-xs text-gray-300 pt-2 pl-4 roundedu">
            &copy; 2024. MAUZO INC. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
